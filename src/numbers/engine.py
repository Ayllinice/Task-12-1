...
# 2. Run linter check
# flake8 brain_games_engine.py
# pylint brain_games_engine.py

# 3. Set up CodeClimate
# - Register at https://codeclimate.com/
# - Add repository
# - Copy Maintainability badge and insert in README.md

# 4. Record gameplay using Asciinema
# sudo apt install asciinema
# asciinema rec brain_games_demo.cast
# - Upload to https://asciinema.org/ and add link in README.md
